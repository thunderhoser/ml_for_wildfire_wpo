...
def _increment_dwmse_one_field(fwi_table_xarray, field_name, extreme_threshold,
    ...
    # predicted_values = (climo_mean + real_data_values) / 2
    predicted_values = 0.9 * real_data_values + 0.1 * climo_mean
    ...
    error_values = sample_weights * (predicted_values - real_data_values) ** 2
