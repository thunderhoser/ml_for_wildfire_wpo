"""Makes templates for Experiment 4 (all-FWI regression)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment04_all_regression/templates'
)
...
METRIC_FUNCTIONS = [
    ...
    custom_metrics.dual_weighted_mse_unmasked(channel_index=3, function_name='isi_dwmse'),
    ...
    custom_losses.dual_weighted_mse_1channel(channel_index=0, channel_weight=CHANNEL_WEIGHTS[0], function_name='ffmc_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=1, channel_weight=CHANNEL_WEIGHTS[1], function_name='dmc_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=2, channel_weight=CHANNEL_WEIGHTS[2], function_name='dc_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=3, channel_weight=CHANNEL_WEIGHTS[3], function_name='isi_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=4, channel_weight=CHANNEL_WEIGHTS[4], function_name='bui_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=5, channel_weight=CHANNEL_WEIGHTS[5], function_name='fwi_dwmse_in_loss'),
    custom_losses.dual_weighted_mse_1channel(channel_index=6, channel_weight=CHANNEL_WEIGHTS[6], function_name='dsr_dwmse_in_loss'),
...
DEFAULT_OPTION_DICT = {
    ...
    chiu_net_arch.LAGTGT_DIMENSIONS_KEY:
        numpy.array([265, 537, 6, 7], dtype=int),
