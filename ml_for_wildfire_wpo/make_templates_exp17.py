"""Makes templates for Experiment 17.

All lead times up to 10 days -- playing with residual blocks, spectral
...
SPECTRAL_COMPLEXITIES_AXIS2 = numpy.array([40, 60, 80, 100], dtype=int)
        ...
        for j in range(len(SPECTRAL_COMPLEXITIES_AXIS2)):
            for k in range(len(RESIDUAL_BLOCK_FLAGS_AXIS3)):
                ...
                output_file_name = (
                    ...
                    'spectral-complexity={2:03d}_use-residual-blocks={3:d}/'
                    'model.keras'
                ).format(
                    OUTPUT_DIR_NAME,
                    PREDICTOR_TIME_STRATEGIES_AXIS1[i],
