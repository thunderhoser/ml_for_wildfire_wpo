"""Plots spread-skill relationship for each target field."""
...
from ml_for_wildfire_wpo.utils import spread_skill_utils as ss_utils
...
INPUT_FILE_HELP_STRING = (
    'Path to input file.  Will be read by `spread_skill_utils.read_results`.'
)
...
def _run(input_file_name, output_dir_name):
    ...
    for this_field_name in rtx.coords[ss_utils.FIELD_DIM].values:
