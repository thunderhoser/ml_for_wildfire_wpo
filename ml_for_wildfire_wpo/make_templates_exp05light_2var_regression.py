"""Makes templates for Experiment 5-light with FFMC/BUI regression."""
...
# TODO(thunderhoser): Add ERA5 constant fields next!!

OUTPUT_DIR_NAME = (
    '/scratch1/RDARCH/rda-ghpcs/Ryan.Lagerquist/ml_for_wildfire_models/'
    'experiment05light_2var_regression/templates'
)
