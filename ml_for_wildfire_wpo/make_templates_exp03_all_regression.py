"""Makes templates for Experiment 3 (all-FWI regression)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment03_all_regression/templates'
)

LOSS_FUNCTION = custom_losses.dual_weighted_mse(
    channel_weights=numpy.array([
        6.014067, 20.231428, 1.464403, 126.009287, 13.615039, 65.445392,
        210.122193
    ]),
...
LOSS_FUNCTION_STRING = (
    ...
    'channel_weights=numpy.array(['
    '6.014067, 20.231428, 1.464403, 126.009287, 13.615039, 65.445392, 210.122193'
    ']), '
    'function_name="loss_dwmse")'
)
