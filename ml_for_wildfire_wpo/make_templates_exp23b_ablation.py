"""Makes templates for Experiment 23b (second step of ablation)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment23b_ablation/templates'
)
...
EXTRA_PREDICTOR_TYPE_STRINGS = [
    'gfs_2d', 'gfs_3d', 'lagged_targets', 'era5_constants', 'residual_baseline'
]
