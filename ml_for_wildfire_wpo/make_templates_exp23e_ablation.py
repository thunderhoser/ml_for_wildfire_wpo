"""Makes templates for Experiment 23e (fifth step of ablation)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment23e_ablation/templates'
)
...
EXTRA_PREDICTOR_TYPE_STRINGS = ['era5_constants', 'residual_baseline']
    ...
    for i in range(len(EXTRA_PREDICTOR_TYPE_STRINGS)):
        ...
        option_dict.update({
            ...
            chiu_net_pp_arch.LAGTGT_DIMENSIONS_KEY:
                numpy.array([160, 160, 2, 7], dtype=int),
        ...
        if EXTRA_PREDICTOR_TYPE_STRINGS[i] == 'era5_constants':
