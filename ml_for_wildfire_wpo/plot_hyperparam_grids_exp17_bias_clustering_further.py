...
BIAS_DISCRETIZATION_INTERVAL_INTERVALS_AXIS1 = numpy.array(['small', 'medium', 'large', 'xl', 'xxl', 'xxxl'])
MIN_CLUSTER_SIZES_PX_AXIS2 = numpy.array([100, 200, 500, 1000, 2000, 5000], dtype=int)
BUFFER_DISTANCES_PX_AXIS3 = numpy.array([0, 1], dtype=int)
DO_BACKWARDS_FLAGS_AXIS4 = numpy.array([1], dtype=int)

BEST_MARKER_TYPE = '*'
BEST_MARKER_SIZE_GRID_CELLS = 0.2
            ...
            for k in range(axis3_length):
                for m in range(axis4_length):
                    this_eval_file_name = (
                        ...
                        'min-cluster-size-px={2:04d}_buffer-distance-px={3:d}_'
