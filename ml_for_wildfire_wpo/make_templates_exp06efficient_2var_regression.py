"""Makes templates for Experiment 6-efficient with FFMC/BUI regression.

Same as Experiment 6-efficient, except with efficient Chiu-net++ implementation.
"""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment06efficient_2var_regression/templates'
)
